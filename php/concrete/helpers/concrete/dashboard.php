	...
	public function getDashboardAndSearchMenus() {
		...
		ob_start(); ?>
			...
			foreach($children as $ch) {
				...
				<?php  if (count($ch2) == 0) { ?>
					<li><a href="<?php echo Loader::helper('navigation')->getLinkTocollection($page, false, true)?>"><?php echo t($page->getCollectionName())?></a><span><?php echo t($page->getCollectionName())?> <?php echo $page->getAttribute('meta_keywords')?></span></li>
				<?php  } ?>
				
				<?php 
				if ($page->getCollectionPath() == '/dashboard/system') { ?>
					<li><a href="<?php echo Loader::helper('navigation')->getLinkTocollection($page, false, true)?>"><?php echo t('View All')?><span><?php echo t($page->getCollectionName())?> <?php echo $page->getAttribute('meta_keywords')?></span></li>
				<?php 				
				}
			...
			foreach($corepages as $page) {
				...
				<h1><a href="<?php echo Loader::helper('navigation')->getLinkToCollection($page, false, true)?>"><?php echo t($page->getCollectionName())?></a></h1>
				...
				foreach($ch2 as $chi) {
					...
					?>
					<li><a href="<?php echo Loader::helper('navigation')->getLinkToCollection($subpage, false, true)?>"><?php echo t($subpage->getCollectionName())?></a></li>
					<?php  
				}
				?>
				</ul>
