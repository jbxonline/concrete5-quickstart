...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Multilingual Setup'), false, 'span12 offset2', false)?>
<?php  
...
<div class="ccm-pane-body">
	...
	<li>
		<label><?php echo $form->checkbox('LANGUAGE_CHOOSE_ON_LOGIN', 1, $LANGUAGE_CHOOSE_ON_LOGIN)?> <span><?php echo t('Offer choice of language on login.')?></span></label>
	</li>
	</ul>
	</div>
	</div>
