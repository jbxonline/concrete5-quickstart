...
<tr <?php  if ($job['jStatus'] == 'RUNNING') {
	...
	<td><a class="run-task" title="<?php echo t('Run')?>" href="<?php echo BASE_URL.$this->url('/tools/required/jobs?auth='.$auth.'&jobId='.$job['jID'])?>" data-jobId="<?php echo $job['jID']?>"></a><span class="run-indicator"></span></td>
	<td><?php echo $job['jID']?></td>
	<td><?php echo $job['jName']?></td>
...
?></td>
	<td class="jLastStatusText"><?php echo $job['jLastStatusText']?></td>
