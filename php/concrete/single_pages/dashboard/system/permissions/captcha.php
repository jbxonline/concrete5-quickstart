...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Captcha Settings'), false, 'span12 offset2', (!is_object($activeCaptcha) || (!$activeCaptcha->hasOptionsForm())))?>
