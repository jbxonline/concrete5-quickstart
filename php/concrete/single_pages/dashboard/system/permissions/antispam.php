...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Spam Control'), false, 'span12 offset2', (!is_object($activeLibrary) || (!$activeLibrary->hasOptionsForm())))?>
