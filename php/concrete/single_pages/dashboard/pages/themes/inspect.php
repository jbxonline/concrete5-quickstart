...
?>
	...
	<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Inspect Theme'), false, 'span14 offset1', false);?>
	...
	<div class="ccm-pane-body" style="padding-top:10px;">
    	...
    	<h3><?php echo t("Theme name: ").$pageTheme->getThemeName()?></h3>
