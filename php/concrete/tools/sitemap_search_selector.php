...
<li class="active"><a href="javascript:void(0)" id="ccm-show-sitemap" onclick="ccm_sitemapSearchSelectorHideBottom()"><?php echo t('Sitemap')?></a></li>
<li><a href="javascript:void(0)" id="ccm-show-search" onclick="ccm_sitemapSearchSelectorShowBottom()"><?php echo t('Search')?></a></li>
</ul>
