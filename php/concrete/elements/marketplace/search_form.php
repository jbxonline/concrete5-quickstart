...
?>
<form id="ccm-marketplace-browser-form" method="get" action="<?php echo $action?>">
...
<div class="clearfix ccm-pane-options-content" <?php  if ($_REQUEST['marketplaceRemoteItemSortBy'] || $_REQUEST['marketplaceIncludeOnlyCompatibleAddons']) { ?>style="display: block" <?php  } ?>>
	<br/>
