		...
		<table class="ccm-style-property-table" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<td style="width: 50%" valign="top">
					<?php  echo t('CSS ID')?>:
					<input name="css_id" type="text" value="<?php echo htmlentities(trim($style->getCustomStyleRuleCSSID()), ENT_COMPAT, APP_CHARSET) ?>" style="width:99%" onkeyup="ccmCustomStyle.validIdCheck(this,'<?php echo str_replace(array("'",'"'),'',$style->getCustomStyleRuleCSSID()) ?>')" /> 
