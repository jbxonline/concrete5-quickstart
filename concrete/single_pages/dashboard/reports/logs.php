        ...
        <table border="0" cellspacing="0" cellpadding="0" class="grid-list zebra-striped">
        	<thead>
                <tr>
                    ...
                    <th class="subheader" style="position: relative">       <input class="btn error" style="position: absolute; top: 4px; right: 4px" type="button" onclick="if (confirm('<?php echo t("Are you sure you want to clear this log?")?>')) { location.href='<?php echo $this->url('/dashboard/reports/logs', 'clear', $valt->generate(), $_POST['logType'])?>'}" value="<?php echo t('Clear Log')?>" />
<?php echo t('Text')?></th>
                </tr>
			</thead>
            <tbody>
