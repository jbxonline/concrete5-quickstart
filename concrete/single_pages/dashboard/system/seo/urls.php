...
echo $dh->getDashboardPaneHeaderWrapper(t('Pretty URLs'), t("Automatically translates your path-based concrete5 URLs so that they don't include %s.", DISPATCHER_FILENAME), 'span10 offset2', false);
?>
