...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Interface Settings'), false, 'span12 offset2', false)?>
...
<legend><?php echo t('Toolbar')?></legend>
<div class="clearfix">
<label><?php echo t('Quick Nav Behavior')?></label>
<div class="input">
<ul class="inputs-list">
	<li><label><?php echo $form->radio('TOOLBAR_QUICK_NAV_BEHAVIOR', '', $TOOLBAR_QUICK_NAV_BEHAVIOR)?> <span><?php echo t('Show quick navigation bar when hovering over edit bar (default).')?></span></label></li>
	<li><label><?php echo $form->radio('TOOLBAR_QUICK_NAV_BEHAVIOR', 'always', $TOOLBAR_QUICK_NAV_BEHAVIOR)?> <span><?php echo t('Always show quick navigation bar.')?></span></label></li>
	<li><label><?php echo $form->radio('TOOLBAR_QUICK_NAV_BEHAVIOR', 'disabled', $TOOLBAR_QUICK_NAV_BEHAVIOR)?> <span><?php echo t('Disable quick navigation bar.')?></span></label></li>
</ul>
</fieldset>
