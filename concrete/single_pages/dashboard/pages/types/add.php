...
?>
    ...
    <form method="post" id="add_page_type" action="<?php echo $this->url('/dashboard/pages/types/add', 'do_add')?>">
    ...
    <div class="ccm-pane-body">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                <tr>
                    <td>
                        <?php echo $form->text('ctName', $_POST['ctName'], array('class' => 'span9'))?>
                    </td>
                    <td>
                        <?php echo $form->text('ctHandle', $_POST['ctHandle'], array('class' => 'span6'))?>
                    </td>
                </tr>
			</tbody>
		</table>
