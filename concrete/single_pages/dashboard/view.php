<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Dashboard'), false, false, false); ?>
...
for ($i = 0; $i < count($categories); $i++) {
	...
	<h3><a href="<?php echo Loader::helper('navigation')->getLinkToCollection($cat, false, true)?>"><?php echo t($cat->getCollectionName())?></a></h3>
	</div>
	...
	<div>
	<a href="<?php echo Loader::helper('navigation')->getLinkToCollection($subcat, false, true)?>"><?php echo t($subcat->getCollectionName())?></a>
	</div>
