...
<?php  if ($_REQUEST['uploaded']) { ?>
	<?php  if (count($_REQUEST['fID']) == 1) { ?>
		<div class="block-message alert-message success"><a class="btn success small" style="float: right; margin-top: -5px" onclick="jQuery.fn.dialog.closeTop()"><?php echo t('Continue')?></a><p><?php echo t('1 file uploaded successfully.')?></p></div>
	<?php  } else { ?>
		<div class="block-message alert-message success"><a class="btn success small" style="float: right; margin-top: -5px" onclick="jQuery.fn.dialog.closeTop()"><?php echo t('Continue')?></a><p><?php echo t('%s files uploaded successfully.', count($_REQUEST['fID']))?></p></div>
	<?php  } ?>
<?php  } ?>
